...
X = table(Mafrica$Product_Category)
pie_label = unique(Mafrica$Product_Category)
pie(X, labels = pie_label, radius = 0.9)
...
meanSales = tapply(Mafrica$Sales, Mafrica$Product_SubCategory, mean)
...
knitr::kable(head(t13LATAM[], 'simple'))
 ##task13
task_latsales = t13LATAM$Sales
task_latregion = t13LATAM$Region

t13LATAMSum = tapply(t13LATAM$Sales,t13LATAM$Region, sum)

knitr::kable(t13LATAM)
...
#TASK14-BOXPLOT FOR LATAM
 # Create example data
t14bar = data.frame('South_America' = rnorm(500),
                   'Caribbean' = runif(500),
                   'Central_America' = rpois(500, 3))
head(t14bar)

#create a boxplot
boxplot(t14bar, vertical = T, cex.axis = 0.5, cex.lab = 0.4,cex.names= 0.6)
